...
<title>YahYa Car Rental | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>MMK<?php echo htmlentities($result->PricePerDay);?> </p>Per Day
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">MMK<?php echo htmlentities($result->PricePerDay);?></p>
