...
DROP TABLE `tblcontactusinfo`;
DROP TABLE `tblcontactusquery`;
DROP TABLE `tblpages`;
DROP TABLE `tblsubscribers`;
DROP TABLE `tblusers`;
...
INSERT IGNORE INTO `admin` (`id`, `UserName`, `Password`, `updationDate`) VALUES
...
INSERT IGNORE INTO `tblbooking` (`id`, `BookingNumber`, `userEmail`, `VehicleId`, `FromDate`, `ToDate`, `message`, `Status`, `PostingDate`, `LastUpdationDate`) VALUES
...
INSERT IGNORE INTO `tblbrands` (`id`, `BrandName`, `CreationDate`, `UpdationDate`) VALUES
...
INSERT IGNORE INTO `tblcontactusinfo` (`id`, `Address`, `EmailId`, `ContactNo`) VALUES
(1, 'Beside Lotteria, Bojoke Street, Pyay', 'soenyuntaung1000@gmail.com', '09694816014');
...
INSERT IGNORE INTO `tblcontactusquery` (`id`, `name`, `EmailId`, `ContactNumber`, `Message`, `PostingDate`, `status`) VALUES
...
INSERT IGNORE INTO `tblpages` (`id`, `PageName`, `type`, `detail`) VALUES
(1, 'About Us ', 'aboutus', '<span style=\"color: rgb(51, 51, 51); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 13.3333px;\">&nbsp;</span><span style=\"color: rgb(52, 52, 52); font-family: Arial, Helvetica, sans-serif;\">As we are not affiliated with any specific automaker, we are able to provide a variety of vehicle makes and models for customers to rent.</span><div><span style=\"color: rgb(62, 62, 62); font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-size: 11px;\"></span><span style=\"color: rgb(52, 52, 52); font-family: Arial, Helvetica, sans-serif;\"><br></span></div>'),
(2, 'FAQs', 'faqs', '																														<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\">CSar rental service that offers a variety of vehicles for rent, including economy, luxury, and SUVs. We aim to provide affordable and reliable transportation solutions to meet your needs. </span>');
...
INSERT  IGNORE INTO `tblsubscribers` (`id`, `SubscriberEmail`, `PostingDate`) VALUES
...
INSERT IGNORE INTO `tblusers` (`id`, `FullName`, `EmailId`, `Password`, `ContactNo`, `dob`, `Address`, `City`, `Country`, `RegDate`, `UpdationDate`) VALUES
