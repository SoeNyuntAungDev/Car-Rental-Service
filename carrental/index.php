...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>There is to deliver exceptional car rental experiences through outstanding customer service, a diverse fleet of vehicles, and competitive pricing. We strive to make your rental process seamless and stress-free, allowing you to focus on what matters most—your journey.</p>
    </div>
    <div class="row"> 
...
<span class="price">MMK<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
