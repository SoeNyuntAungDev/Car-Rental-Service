...
<title>YahYa Car Rental|| Contact Us Page</title>
<!--Bootstrap -->
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:09694816014"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:soenyuntaung1000@gmail.com"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
